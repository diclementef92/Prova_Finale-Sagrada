...
public class ColorVarietyTest {
     ...
     * in a board with five dices with different colors
     */
    @Test
    public void returnScore() {
        ...
        ColorVariety colorVariety = new ColorVariety("asd", "asd", 4);
        ...
        assertEquals(4, colorVariety.returnScore(playerBoard));
    }
}